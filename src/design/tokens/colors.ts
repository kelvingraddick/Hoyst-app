...
export function getHoystThemeColors(
  ...
  return {
    ...
    textMuted: isDark ? brandColors.gray : '#5F6B76',
    textSubtle: isDark ? brandColors.graySoft : '#63707B',
    ...
    successForeground: isDark ? brandColors.green : '#16702F',
    warning: brandColors.orangeStrong,
    warningForeground: isDark ? brandColors.orangeStrong : '#A24F10',
    danger: brandColors.red,
    dangerForeground: isDark ? brandColors.red : '#BA2D48',
    accent: brandColors.purple,
    accentForeground: isDark ? brandColors.purple : '#6840C6',
    accentSecondary: brandColors.purpleBright,
    accentSecondaryForeground: isDark ? brandColors.purpleBright : '#6840C6',
    accentTertiary: brandColors.blue,
    accentTertiaryForeground: isDark ? brandColors.blue : '#206F96',
    accentWarm: brandColors.orangeStrong,
    accentWarmForeground: isDark ? brandColors.orangeStrong : '#A24F10',
