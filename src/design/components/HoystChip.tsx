...
export function HoystChip({
  ...
  const palette =
    tone === 'green'
      ? {backgroundColor: 'rgba(68,216,92,0.14)', color: theme.success}
      : tone === 'orange'
        ? {backgroundColor: 'rgba(255,138,61,0.14)', color: theme.warning}
        : tone === 'purple'
          ? {backgroundColor: 'rgba(139,92,246,0.16)', color: theme.accentSecondary}
